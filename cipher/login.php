...
?>
	<body>
		...
		<div id="formShit">
			...
			<form class="form-horizontal shit" type="form" id="logShitForm" enctype="multipart/form-data" method="post" action="login.php">
			  ...
			  <div class="form-group"> 
				<div class="col-sm-offset-0 col-sm-12">
				  <button type="submit" name="LOGIN" value="LOGIN" class="btn btn-block suckMe">LOGIN</button>
				</div>
			  </div>
			  
			  <div class="form-group"> 
				<div class="col-sm-offset-0 col-sm-12" id='loginsLINK'>
				  <a href="reg.php" >___ SIGN UP ___</a>
				</div>
			  </div>
			</form>
		</div>
