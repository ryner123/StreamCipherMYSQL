...
?>
	<body>
		...
		<div id="formShit">
			...
			<form class="form-horizontal shit" type="form" id="regShitForm" enctype="multipart/form-data" method="post" action="NotepadReg.php">
			  ...
			  <div class="form-group"> 
				<div class="col-sm-offset-1 col-sm-10">
				  <button type="submit" name="NotepadReg" value="NotepadReg" class="btn btn-block suckMe">REGISTER</button>
				</div>
			  </div>
			  
			  <div class="form-group"> 
				<div class="col-sm-offset-0 col-sm-12" id='loginsLINK'>
				  <a href="NotepadLogin.php" >___ LOGIN ___</a>
				</div>
			  </div>
			</form>
		</div>
